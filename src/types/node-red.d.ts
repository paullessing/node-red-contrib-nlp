...
export interface Nodes {
     ...
     */
    addCredentials(id: NodeId, creds: NodeCredentials): void;
    /**
     * Gets the credentials for the given node id.
     * @param id the node id for the credentials
     * @return the credentials
     */
    getCredentials(id: NodeId): NodeCredentials;
    /**
    ...
    registerType<T extends NodeProperties>(type: string, constructor: (props: T) => any, opts?: RegisterNodeOpts): void;
}

interface RegisterNodeOpts {
    credentials: NodeCredentials;
    settings: unknown;
}

interface NodeCredentials {
    [key: string]: { type: 'text' | 'password' };
}
